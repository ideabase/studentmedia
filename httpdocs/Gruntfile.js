...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      my_target: {
        files: {
          'assets/js/min/critical-min.js': ['assets/js/jquery.js','assets/js/critical.js'],
          'assets/js/min/scripts-min.js': ['assets/js/carousel.js','assets/js/lazyload.js','assets/js/video-lazy.js','assets/js/scripts.js'],
